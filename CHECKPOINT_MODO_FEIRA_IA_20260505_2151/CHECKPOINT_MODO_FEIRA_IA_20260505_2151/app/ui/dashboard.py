...
if analysis_id:
    ...
    if isinstance(evidencias_ia, list) and evidencias_ia:
        ...
        for ev in evidencias_ia[:4]:
            ...
            titulo_ev = ev.get("titulo", "Evidência da conversa")
